...
# 保存数据函数
def save_data(args, timesteps, timestamps, actions, dataset_path, cam_infos=None, extrinsics=None):
...
def main():
    ...
    extrinsics = None
    extrinsics_path = os.path.join(dataset_dir, "extrinsics.json")
    if os.path.exists(extrinsics_path):
        with open(extrinsics_path, "r") as f:
            extrinsics = json.load(f)

    save_data(args, timesteps, timestamps, actions, dataset_path, ros_operator.cam_infos, extrinsics)
